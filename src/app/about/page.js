  ...
  return (
    <div className="max-w-6xl mx-auto space-y-4">
      ...
      <p>
        ...
        We also have a section dedicated to movie news and trailers, keeping you
        updated with the latest happenings in the world of cinema. Thank you for
        ...
        free to contact us. We are always looking for ways to improve and
        enhance the use experience on our website. Happy browsing!
      </p>
    </div>
  );
};
